...
import { Save, Lock, Wand2, Info, Search, Trash2, XCircle, AlertTriangle, Sparkles } from "lucide-react";
    ...
    <div className="min-h-screen bg-gray-100 p-4 md:p-8">
      <div className="max-w-6xl mx-auto bg-white rounded-3xl shadow-xl p-6 md:p-10 border border-gray-300">
            ...
            <div>
              ...
              <div className="relative">
                  <input 
                    ...
                    onBlur={() => handleAutoTranslate("folder")} // ✨ Auto Translate
                    placeholder="e.g. Bhori Sakhi" 
                    className="w-full p-3 border-2 border-amber-400 bg-amber-50 rounded-lg text-black font-bold" 
                  />
                  <span className="absolute right-2 top-3 text-xs text-amber-600 bg-white px-1 rounded border border-amber-200">✨ Auto</span>
              </div>
        ...
        <h3 className="text-xl font-bold text-black mb-3 bg-gray-200 p-2 rounded flex justify-between">
            Titles 
            <span className="text-xs text-gray-500 font-normal mt-1">★ Type in Hinglish & click outside to auto-translate</span>
        </h3>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
          <div className="relative">
             <input 
                ...
                onChange={handleChange} 
                onBlur={() => handleAutoTranslate("title_HING")} // ✨ MAGIC
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
            <div className="relative">
                <textarea 
                    ...
                    onChange={handleChange} 
                    onBlur={() => handleAutoTranslate("desc_HING")} // ✨ MAGIC
        ...
        <div className="space-y-6">
             ...
             <div>
                <label className="font-bold text-lg text-black block mb-2 bg-amber-100 inline-block px-2 rounded border border-amber-300">
                  Content (Hinglish) - Type Here for Magic ✨
                </label>
                <textarea 
                    name="content_HING" 
                    value={formData.content_HING} 
                    onChange={handleChange} 
                    onBlur={() => handleAutoTranslate("content_HING")} // ✨ MAGIC
                    rows={6} 
            ...
            <textarea name="content_HI" value={formData.content_HI} onChange={handleChange} rows={6} placeholder="Hindi Content (Auto-Filled)..." className="w-full p-4 border-2 border-gray-300 bg-gray-50 rounded-xl text-black font-mono text-base" />
            <textarea name="content_EN" value={formData.content_EN} onChange={handleChange} rows={6} placeholder="English Content (Auto-Filled)..." className="w-full p-4 border-2 border-gray-300 bg-gray-50 rounded-xl text-black font-mono" />
        </div>
